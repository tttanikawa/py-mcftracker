...
def run_mfct(path2video, path2det, frame_offset, frame_count, iid):		
	...
	detections, tags, images = helper.read_input_data(path2det, path2video, slice_start, slice_end, det_in, frame_indices)
	...
	debug.get_patch_by_id(tracker, 21, detections, images)
